...
- Canonical spec files: `docs/iris/IRIS_RELEASE_GATE.md`, `docs/iris/IRIS_RUNTIME_OPERATION_RUNBOOK.md`, `docs/iris/IRIS_PRODUCTION_REAL_EVIDENCE_MANIFEST.md`, `docs/iris/IRIS_PRODUCTION_LIVE_HANDOFF_BUNDLE.md`, `docs/iris/IRIS_PRODUCTION_GO_NOGO_PACKAGE.md`, `IRIS_SPEC_AUTHORITY.md`.
...
- Missing or blocked: priority1 real worker/engine/OBS/TTS/Live2D/DB/YouTube/Game proof remains blocked; real evidence acquisition manifest, live handoff bundle, and production go/no-go package are spec-only and do not perform production go.

...
const CASES = [
  ...
  ['v101_self_test_registered_pass', gates.buildV101SelfTestRegistrationReport, { registeredSelfTests: ['codex-v101-self-test.mjs'], registeredStatusKeys: ['v101SelfTestStatus'] }, 'v101SelfTestStatus', 'pass'],

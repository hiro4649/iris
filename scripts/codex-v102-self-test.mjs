...
const CASES = [
  ...
  ['v102_self_test_registered_pass', gates.buildV102SelfTestRegistrationReport, { registeredSelfTests: ['codex-v102-self-test.mjs'], registeredStatusKeys: ['v102SelfTestStatus'] }, 'v102SelfTestStatus', 'pass'],

...
function buildV092SelfTestReport() {
  ...
  let report = {
    versionLineageStatus: {
      status: /^CODEX_QUALITY_HARNESS_FILE v1\.1\.6$/.test('CODEX_QUALITY_HARNESS_FILE v1.1.6') ? 'pass' : 'fail',
      reasonCodes: [],
      safeSummaryOnly: true,
    },
  };
  assertCase('version_lineage_current_marker_fixture_matches_v116', report.versionLineageStatus.status === 'pass', failures, cases, report.versionLineageStatus.status, report.versionLineageStatus.reasonCodes);

...
function buildV092SelfTestReport() {
  ...
  let report = { versionLineageStatus: { status: marker === `CODEX_QUALITY_HARNESS_FILE v${HARNESS_VERSION}` && HARNESS_VERSION === '1.0.7' ? 'pass' : 'fail', reasonCodes: marker === `CODEX_QUALITY_HARNESS_FILE v${HARNESS_VERSION}` && HARNESS_VERSION === '1.0.7' ? [] : ['active_marker_version_mismatch'], safeSummaryOnly: true } };

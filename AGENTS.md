...
For v1.2.3 use `docs/process/CODEX_V123_SPEC.md` and `docs/process/CODEX_ACTIVE_POLICY_INDEX.json`. Profile: `HARNESS_V123_TARGET_INSTALL`. Preserve v1.1.8/v1.1.9 and v1.2.0-v1.2.2 compatibility. No product/package/runtime/workflow/raw-log/full-history/wallet/RPC/deploy/self-approval/GitHub approval/readiness/legal/YouTube claim.
## Prime Directive

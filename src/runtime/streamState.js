  ...
  return {
    ...
    updateFromRuntimeResult(result) {
      ...
      state.history.push({
        ...
        speech_rate_label: state.last_speech_rate_profile?.speech_rate_label ?? null,
        response_language: state.last_language_profile?.selected_language ?? null,
        ...
        text_available: state.last_text !== "",
        text_length: [...String(state.last_text ?? "")].length,
